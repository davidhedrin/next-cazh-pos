  ...
  await prisma.$transaction(async (tx) => {
    ...
    await tx.roleMenus.createMany({
      data: [
        ...
        { role_id: 1, menu_id: 4, menu_slug: "mdl-abs", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 5, menu_slug: "mdl-msg", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 6, menu_slug: "mdl-anc", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 7, menu_slug: "whs-prd", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 8, menu_slug: "whs-prd-prs", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 9, menu_slug: "whs-prd-ctg", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 10, menu_slug: "whs-ivt", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
        { role_id: 1, menu_id: 11, menu_slug: "whs-dsc", create: true, read: true, update: true, delete: true, createdBy: "SEEDER" },
